...
class App extends Component {
  ...
  findUsersForUsername = (e) => {
    e.preventDefault();
    axios.get(`http://localhost:3002/api/user/${this.state.inputWithUsername}`)
      .then(res => {
        this.setState({
          findUsers: [...res.data],
        })
  ...
  deleteUser = (e) => {
    e.preventDefault();
    axios.delete(`http://localhost:3002/api/user/${this.state.idForDelete}`)
    .then(res => {
      // this.setState({
  ...
  updateUser = (e) => {
    e.preventDefault();
    axios.put(`http://localhost:3002/api/user/${this.state.idForUpdate}`, {
